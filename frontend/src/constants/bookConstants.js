...
export const YELP_BOOK_SAVE_REQUEST = 'YELP_BOOK_SAVE_REQUEST'
export const YELP_BOOK_SAVE_SUCCESS = 'YELP_BOOK_SAVE_SUCCESS'
export const YELP_BOOK_SAVE_FAIL = 'YELP_BOOK_SAVE_FAIL'
export const YELP_BOOK_SAVE_RESET = 'YELP_BOOK_SAVE_RESET'
